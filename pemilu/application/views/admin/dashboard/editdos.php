	...
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url('dosen/edit/'.$dos['id_dos']);?>" method="post">
			<div class="control-group">
				<label class="span1"></label><label class="span3">NIP</label>
				<div class="controls">
					<input type="text" name="id" readonly value="<?php echo $dos['id_dos'];?>" data-validation-required-message="Harus Diisi" placeholder="NIP" class="span10" required autocomplete='off'>
				</div>
			</div>
			<div class="control-group">
